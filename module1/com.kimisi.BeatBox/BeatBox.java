...
public class BeatBox {
	...
	public void buildGUI(){
		theFrame = new JFrame("SpiceMyMile бит машина");						// Создание фрейма
		...
		JLabel imagePanelNike = new JLabel();
		imagePanelNike.setIcon(new ImageIcon("g2JSPO_p94Q.jpg"));
		//Image Nika = new ImageIcon("g2JSPO_p94Q.jpg").getImage();
		...
		//imagePanelNike.add(Nika);
		buttonBox.add(imagePanelNike);
